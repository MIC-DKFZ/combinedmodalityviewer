...
CONTAINER_REGISTRY_URL="registry.hzdr.de/kaapana/releases" # empty for local build or registry-url like 'dktk-jip-registry.dkfz.de/kaapana' or 'registry.hzdr.de/kaapana/kaapana'
CONTAINER_REGISTRY_USERNAME="mic-internal-0.5.2"
CONTAINER_REGISTRY_PASSWORD="glpat-m6y99BetJTms4d2g_JHBFm86MQp1Om4xbgk.01.0z1iuju48"
