...
class AutoSegmentationPipelineOperator(KaapanaBaseOperator):
    """
    ...
    def __init__(
        ...
        dag,
        task,
        name="auto-segmentation-pipeline",
        output_type="nifti",
        multilabel=False,
        fast=False,
        preview=False,
        ...
        **kwargs,
        ...
        super().__init__(
            dag=dag,
            image=f"{DEFAULT_REGISTRY}/auto-segmentation-pipeline:{KAAPANA_BUILD_VERSION}",
            name=name,
